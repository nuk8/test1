...
public class TasteDto {
	...
	private String tchildrens;
	private String thistorica;
	private String troco;
	private String tdisaster;
	private String tchivalry;
	private String twestern;
	private String thotguy;
	private String thightteen;
	...
	public String getTchildrens() {
		return tchildrens;
	}
	public void setTchildrens(String tchildrens) {
		this.tchildrens = tchildrens;
	}
	public String getThistorica() {
		return thistorica;
	}
	public void setThistorica(String thistorica) {
		this.thistorica = thistorica;
	}
	...
	public String getTchivalry() {
		return tchivalry;
	}
	public void setTchivalry(String tchivalry) {
		this.tchivalry = tchivalry;
	}
	...
	public String getThightteen() {
		return thightteen;
	}
	public void setThightteen(String thightteen) {
		this.thightteen = thightteen;
	}
	...
	public String toString() {
		return "TasteDto [tseq=" + tseq + ", tuseq=" + tuseq + ", taction=" + taction + ", tcomedy=" + tcomedy
				...
				+ ", tanimation=" + tanimation + ", tchildrens=" + tchildrens + ", thistorica=" + thistorica
				+ ", troco=" + troco + ", tdisaster=" + tdisaster + ", tchivalry=" + tchivalry + ", twestern="
				+ twestern + ", thotguy=" + thotguy + ", thightteen=" + thightteen + ", tdomestic=" + tdomestic
				+ ", tforeign=" + tforeign + "]";
	}
	public TasteDto(int tseq, int tuseq, String taction, String tcomedy, String tcrime, String tdocumentary,
			...
			String trabbit, String tanimation, String tchildrens, String thistorica, String troco, String tdisaster,
			String tchivalry, String twestern, String thotguy, String thightteen, String tdomestic, String tforeign) {
		super();
		this.tseq = tseq;
		this.tuseq = tuseq;
		this.taction = taction;
